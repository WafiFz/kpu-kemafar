...
wajib_pilih_sesuai_angkatan($database["angkatan"], "2019");

if(isset($_POST["coblos"])){
    if(coblos2($_POST, "bpm19") > 0 && edit_status_bpm($_POST) > 0){
...
<head>
    <?php header_html(" - Pilih BPM 2019"); ?>
...
<body class="paper-bg2">
    ...
    <section id="pilih" class="py-5 px-sm-5 cont-h-100 d-flex align-items-center">
        <div class="container text-center">
            <h1>Pilih BPM 2019</h1>
            <div class="row justify-content-center">
                <?php for($i=1; $i<=8; $i++) : ?>
                <div class="container col col-10 col-lg-3 col-sm-6 col-md-4 p-3 item-center" data-aos="fade-up">
                    <div class="card p-3 h-100">
                        <div class="card-body">
                            <a href="pilih-bpm-19.php?pilih=<?= $i; ?>" style="color:black; text-decoration:none;">
                                <div class="row g-2  justify-content-center">
                                    <div class="no-urut" style="width: 38px; height:38px;"><?= $i; ?></div>
                                    <img src="img/bpm/19/<?= $i; ?>.png" alt="" class="img-fluid"
                                        style="border-radius:50%" />
                                    <h2 style=" font-size:large;"><?= nama_bpm19($i); ?></h2>
                                    <p><?= keterangan_bpm19($i); ?></p>
                                </div>
                            </a>
                        </div>
                    </div>
    ...
    <?php 
        if($pilihan > 8 || $pilihan < 1){
            echo "<script>
                    document.location.href = 'Pilih-BPM2019';
                </script>";
            exit;
        } 
    ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-5 text-center">
                    <p>Konfirmasi</p>
                    <h5>Anda Memilih Calon <?= $pilihan; ?>:<br> <?= nama_bpm19($pilihan); ?></h5>
                    <form action="" method="POST">
                        ...
                        <input type="text" name="pilihan" value="<?php nama_bpm19($pilihan); ?>" hidden />
