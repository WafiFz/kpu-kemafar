...
wajib_login_panitia();
$table = "pemilih";
$database = query("SELECT * FROM $table WHERE status is NULL AND angkatan = '2019'");
?>
<!DOCTYPE html>
<html lang="en">

<head>
    <?php header_html(" - Belum Memilih 2019"); ?>
</head>
        ...
        <div class="container">
            ...
            <?php 
                ...
                if(isset($_POST["search"])){
                    $database = search_pemilih_belum($_POST["keyword"], "2019");
                } 
            ?>
