...
wajib_login_panitia();
$table = "pemilih";
$database = query("SELECT * FROM $table WHERE angkatan = '2017'");
...
<head>
    <?php header_html(" - Terdaftar 2017"); ?>
</head>
...
<body>
    ...
    <section id="data-tabulasi" class="p-3 p-sm-5 cont-h-100 d-flex align-items-center paper-bg">
        <div class="container">
            <h1 class="text-center mb-4">Terdaftar Sebagai Pemilih</h1>
            <?php 
                //tombol search ditekan
                if(isset($_POST["search"])){
                    $database = search_pemilih($_POST["keyword"], "2017");
                } 
            ?>
