...
wajib_login_panitia();
$table = "pemilih";
$database = query("SELECT * FROM $table WHERE status = 'Done' AND angkatan = '2018'");
...
<head>
    <?php header_html(" - Sudah Memilih 2018"); ?>
</head>
        ...
        <div class="container">
            ...
            <?php 
                ...
                if(isset($_POST["search"])){
                    $database = search_pemilih_sudah($_POST["keyword"], "2018");
                } 
            ?>
